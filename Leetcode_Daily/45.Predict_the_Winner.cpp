...
public:
    int solve(int left, int right, vector<int>& nums,
        ...
        // Current player takes it, so the score difference is that number.
        if (left == right)
            return nums[left];
        ...
        // [left+1 ... right] and can obtain a score difference
        // of solve(left+1,right).
        //
        // Therefore our final advantage is:
        //
        // nums[left] - opponentAdvantage
        int takeLeft =
        ...
        // We play optimally, so choose the better move.
